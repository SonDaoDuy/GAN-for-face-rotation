...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--nepochs_no_decay', type=int, default=330, help='# of epochs at starting learning rate')
        ...
        self._parser.add_argument('--param_k', type=float, default=0, help='param_k')
        self._parser.add_argument('--lambda_k', type=float, default=1e-3, help='param_k')
        self._parser.add_argument('--gamma_k', type=float, default=0.4, help='param_k')
